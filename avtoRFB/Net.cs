...
namespace avtoRFB
{
    class Net
    {
        ...
        public string GetHtml(string url, string postData, string referer) //Возвращает содержимое поданной страницы
        {
            string HTML = "";
        ...
        public string PostRegistration(string url, string postMessage, string referer) //Возвращает содержимое поданной страницы
        {
            string HTML = "";
